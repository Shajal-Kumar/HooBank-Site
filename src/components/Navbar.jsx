...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex py-6 justify-between items-center navbar'>
      ...
      {/* If you can't see the navbar items on the screen, its because this code is not for mobile devices, this is for monitors. The code for mobile devices in written after this one. */}
